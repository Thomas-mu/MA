...
Diese neue Folge untersucht einen kontrolliert veränderten Luftstromzustand. Sie ist kein Defektnachweis. Die gerade abgeschlossene unabhängige Normalitätsprüfung bleibt ein eigener Versuch; ihre Rohdaten und Ergebnisse werden nicht als neue Messungen dieser Folge wiederverwendet.
...
Jede Phase hat eine eigene aktuelle Freigabe. Vor `normal_before` fehlen noch die Bestätigung des vollständigen Stillstands und der aktuellen Bereitschaft ohne Platte bei angeschlossener externer 12-V-Versorgung. Die allgemein erteilte Arbeitsanweisung ersetzt diese Zustandsbestätigung nicht.
...
Die vorausgegangene Normalitätsprüfung ergab bereits normale Fehlalarme bei RMS und Isolation Forest. Diese Ergebnisse bleiben erhalten. Einzelne Alarme während der Plattenphase belegen daher keine eindeutige Zuordnung zur Platte. Der bislang fehlalarmfreie Autoencoder hat damit noch keine nachgewiesene Empfindlichkeit gegenüber veränderten Zuständen. Eine einzelne neue Folge belegt weder allgemeine Wiederholbarkeit noch eine erfolgreiche allgemeine KI-Erkennung.
