...
def benchmark_worker(args) -> None:
    ...
    result = {"method": args.method, "runtime": runtime, "provenance": provenance(),
              ...
              "warmup_windows": args.warmup, "measured_windows": args.windows,
              ...
              "cpu_note": "CPU-Zeit gesamter Prozess inkl. RSS-Sampler und Schleifenverwaltung; kurze Läufe haben grobe Betriebssystem-Auflösung.",
...
def main():
    ...
    if args.threads < 1 or getattr(args, "windows", 1) < 1 or getattr(args, "warmup", 0) < 0:
        raise ValueError("Threads/Fenster positiv; Warmup nichtnegativ erforderlich.")
