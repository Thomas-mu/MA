...
def main():
    ...
    # Match CSV missing-value representation (None becomes an empty field/NaN).
    current = pd.read_csv(StringIO(current.to_csv(index=False)), float_precision="round_trip")
